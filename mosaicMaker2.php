...
<script type="text/javascript">
    ...
    function changePlotsPerRow() {
	document.forms["plotsperrowform"].submit();
    }
</script>
...
<div id="nav">
	...
	<!-- <li onClick="toggle_visibility('arrows')">Arrows</li> -->
  	<li>
		<?php
			echo "<a href=\"$scriptname?subnet=$previousSubnet&year=$year&month=$month&day=$day&hour=$hour&minute=$minute&numhours=$numhours\">&#9650 $previousSubnet</a>\n";
		?>
	</li>
  	<li>
		<?php
			echo "<a href=\"$scriptname?subnet=$nextSubnet&year=$year&month=$month&day=$day&hour=$hour&minute=$minute&numhours=$numhours\">&#9660 $nextSubnet</a>\n";
		?>
	</li>
  	<li>
		<?php
         		...
         		echo "<a href=\"$scriptname?subnet=$subnet&year=$pyear&month=$pmonth&day=$pday&hour=$phour&minute=$pminute&numhours=$numhours\">&#9668 Earlier</a>\n";
		?>
	</li>
  	<li>
		<?php
         		...
         		echo "<a href=\"$scriptname?subnet=$subnet&year=$nyear&month=$nmonth&day=$nday&hour=$nhour&minute=$nminute&numhours=$numhours\">&#9658 Later</a>\n";
		?>
	</li>
  	<li>
		<?php
		        echo "<a href=\"$scriptname?subnet=$subnet&starthour=$numhours&endhour=0\">&#9658&#9658Now</a>\n";
		?>
	</li>
	<li>
		<?php
	...
	<li>
		<?php
		        printf("<td><form id=\"plotsperrowform\">Plots/row<input type=\"text\" name=\"plotsPerRow\" value=\"%.0f\" size=\"4\" onChange=\"changePlotsPerRow()\" /></form> ",$plotsPerRow);
		?>	
	</li>	
...
<div><script language="Javascript" type="text/javascript">now = new Date;document.write("<p>Plotted at: " + now.toUTCString()  + "</p>");</script></div>
